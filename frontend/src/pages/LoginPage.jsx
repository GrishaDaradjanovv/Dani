...
const LoginPage = ({ auth }) => {
  ...
  return (
    <div className="min-h-screen bg-cream flex" data-testid="login-page">
      {/* Left Panel - Form */}
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <h1 className="font-heading text-3xl text-deep-navy mb-2">Welcome Back</h1>
          ...
          <p className="text-center text-deep-navy/60">
            ...
            <Link to="/register" className="text-terracotta hover:underline font-medium" data-testid="register-link">
              Sign up
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-terracotta/20 to-deep-navy/40" />
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <blockquote className="text-2xl font-heading italic mb-4">
            "The greatest wealth is health."
          </blockquote>
          <cite className="text-white/80">— Virgil</cite>
        </div>
      </div>
    </div>
  );
